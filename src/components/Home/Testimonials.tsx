        ...
        <div className="relative overflow-hidden">
          ...
          >
            {duplicatedTestimonials.map((testimonial, index) => (
              <motion.div
                key={index}
                className="w-[500px] shrink-0 bg-white p-10 rounded-xl shadow-lg relative group hover:bg-gradient-to-br hover:from-blue-50 hover:via-sky-50 hover:to-indigo-50 transition-all duration-300 mb-10"
                whileHover={{ 
                  scale: 1.05,
