...
const HeroContent = () => {
  return (
    <div className="backdrop-blur-sm bg-black/30 p-8 rounded-lg max-w-2xl">
      <motion.h1
      ...
      >
        ...
        <Link
          to="/contact"
          className="inline-block bg-transparent text-yellow-500 px-8 py-3 rounded-md border-2 border-yellow-500 hover:bg-yellow-500/10 transition-colors text-center"
        >
          Get a Quote
        </Link>
      </motion.div>
